                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="myNavbar">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li class="active"><a href="carrinho.jsp" id="linkcarrinho"><span class="glyphicon glyphicon-shopping-cart"></span> Carrinho <span class="badge">${carrinho.itens.size()}</span></a></li>
                    ...
                    <tbody>
                        ...
                        <c:forEach var="item" items="${carrinho.itens}">
                            ...
                            <tr>
                                ...
                                <td style="width: 50%;"><a href="infoproduto.jsp">${item.produto.nome}</a></td>
                                <td style="width: 10%;"><input type="text" style="width: 80%;" pattern="[0-9]+" value="${item.quantidade}"></td>
