                ...
                <form action="Cadastrar" method="post" >
                   ...
                   <div class="form-group" id="inputcnpj" style="display: none">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="nome" id="nome" maxlength="50" value="${pf.nome}" pattern="[a-zA-Z\s]+" required>
                    </div>
                   <div class="form-group">
                   ...
                   <!-- <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="num" id="num" value="${endereco.numero}" required>
                    </div>
