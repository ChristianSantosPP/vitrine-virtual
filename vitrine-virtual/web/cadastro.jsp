            ...
            <div class="container-fluid">
                ...
                <form action="Cadastrar" method="post" >
                    ...
                    <div class="form-group" id="inputcnpj" style="display: none">
                        ...
                        <input type="text" class="form-control" name="cnpj" id="cnpj" maxlength="14" pattern="[0-9]{2}.?[0-9]{3}.?[0-9]{3}/?[0-9]{4}-?[0-9]{2}">
                        <small>Ex.: 00.000.000/0000-00</small>
                    </div>
                   <div class="form-group">
                        <label for="nome" id="labelnome">Nome:</label>
                        <input type="text" class="form-control" name="nome" id="nome" maxlength="50" placeholder pattern="[a-zA-Z\s]+" required>
                    </div>
                    <div class="form-group">
                        <label for="mail">E-mail:</label>
                        <input type="email" class="form-control" name="email" id="mail" maxlength="30" required>
                    </div>
                    <div class="form-group">
                        <label for="user">Usuário:</label>
                        <input type="text" class="form-control" name="user" id="user" maxlength="15" pattern="[a-zA-Z0-9]+" required>
                    </div>
                    <div class="form-group">
                        <label for="psw">Senha:</label>
                        <input type="password" class="form-control" name="senha" id="psw" maxlength="15" pattern="[A-Za-z0-9]*" required>
                        <small>Letras maiúsculas, minúsculas e números. Máximo de 15 caracteres!</small>
                    </div>                 
                    <!-- div class="form-group">
                        <label for="rua">Rua:</label>
                        <input type="text" class="form-control" name="rua" id="rua" maxlength="50" pattern="[A-Za-z\s]+" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="comp" id="comp" maxlength="30" required>
                        <small>Ex.: Blobo B Apartamento 200</small>
                    </div>
			<div class="form-group">
                        <label for="cep">CEP:</label>
                        <input type="text" class="form-control" id="cep" name="cep" maxlength="10" pattern="[0-9]{5}-?[0-9]{3}" required>
                        <small>Ex.: 00000-000</small>
                    </div>     
                    <div class="form-group">
                        <label for="rua">Bairro:</label>
                        <input type="text" class="form-control" name="bairro" id="rua" maxlength="50" pattern="[A-Za-z\s]+" required>
                    </div>           
                    <div class="form-group">
                        <label for="cidade">Cidade:</label>
                        <input type="text" class="form-control" name="cidade" id="cidade" maxlength="50" pattern="[A-Za-z\s]+" required>
                    </div>
                    <div class="form-group">
                        <label for="estado">Estado:</label>
                        <input type="text" class="form-control" name="estado" id="estado" maxlength="50" pattern="[A-Za-z\s]+" required>
                    </div>      
                    <div class="form-group">
                        <label for="fone">Telefone Fixo:</label>
                        <input type="text" class="form-control" name="fone" id="fone" maxlength="13" pattern="[(?[0-9]{2})?[0-9]{4}-?[0-9]{4}]">
                        <small>Ex.: (00)0000-0000 </small>
                    </div>               
                    <div class="form-group">
                        <label for="cel">Celular:</label>
                        <input type="text" class="form-control" name="cel" id="cel" maxlength="14">
